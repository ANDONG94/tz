...
//import com.tdkj.shiro.filter.CaptchaValidateFilter;
import com.tdkj.shiro.filter.KickoutSessionControlFilter;
import com.tdkj.shiro.filter.MyFormAuthenticationFilter;
import com.tdkj.shiro.realm.MyShiroRealm;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shirFilter(SecurityManager securityManager) {
        ...
        filterChainDefinitionMap.put("/CommunityFactoryAccount/context/*", "anon");
...
//        //注入ehCache管理器
    ...
    public DefaultWebSessionManager configWebSessionManager(){
        ...
        // 设置全局session超时时间
        manager.setGlobalSessionTimeout(1 * 60 *100*1000);
