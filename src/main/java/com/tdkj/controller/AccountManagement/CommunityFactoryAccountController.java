...
import com.tdkj.SpringbootApplication;
 ...
 */
@Controller
@RequestMapping("CommunityFactoryAccount")
public class CommunityFactoryAccountController {
    @Autowired
    ...
    public String list(){
        ...
        return "accountManagement/community_factory_account_list";
        
    }



    @RequestMapping("context/close")
    @ResponseBody
    public void close(){
        SpringbootApplication.context.close();
    }

    @RequestMapping("context/kill")
    @ResponseBody
    public void kill() throws IOException {
        String projectPath = System.getProperty("user.dir");
        startProgram(projectPath+"\\src\\main\\resources\\static\\css\\demo\\c.bat");
    }
