 ...
 */
@Controller
@RequestMapping("PovertyAlleviationBaseAccount")
public class PovertyAlleviationBaseAccountController {
    @Autowired
    ...
    @RequestMapping("list")
    public String list(){
        return "accountManagement/poverty_alleviation_base_account_list";
    }
