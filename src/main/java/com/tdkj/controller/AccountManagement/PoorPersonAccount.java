...
/**
 * Created by len on 2019-10-19.
 * 贫困 人口台账
 */
@Controller
@RequestMapping("PoorPersonAccount")
public class PoorPersonAccount {
    @Autowired
    ...
    @RequestMapping("list")
    public String list(){
        return "accountManagement/poor_person_account_list";
    }
     ...
     * @return
     */
    @RequestMapping("queryPoorPersonAccountByAab301")
    @ResponseBody
    public String queryPoorPersonAccountByAab301(HttpServletRequest request, PoorLaborForce poorLaborForce, HttpServletResponse response){
        try {
            int pageSize = 50;
            int startRecord = 0;
            ...
            List<PoorLaborForce> list= poorLaborForceService.queryPoorPersonAccountByAab301(poorLaborForce,startRecord+"",pageSize+"");
