...
/**
 * Created by hedd on 2019/11/21.
 * 就业培训查询
 */
@Controller
@RequestMapping("EmploymentSituationTraining")
public class EmploymentSituationTrainingController {
    @Autowired
    ...
    @RequestMapping("list")
    public String list(){
        return "accountManagement/employment_situation_training";
    }
     ...
     * @return
     */
    @RequestMapping("queryEmploymentSituationTrainingByAab301")
    @ResponseBody
    public String queryEmploymentSituationTrainingByAab301(HttpServletRequest request, EysPlf eysPlf, HttpServletResponse response){
        try {
            int pageSize = 50;
            int startRecord = 0;
            ...
            eysPlf.setShowscope("1");
            List<EysPlf> list= employmentSituationService.queryEmploymentSituationTrainingByAab301(eysPlf,startRecord+"",pageSize+"");
            String countlist = employmentSituationService.queryAllEmploymentSituationTrainingByAab301(eysPlf);
