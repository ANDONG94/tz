...
@Controller
@RequestMapping("IncubatorBaseTobeComplete")
public class IncubatorBaseTobeCompleteController {
    ...
    @RequestMapping("list")
    public String list() {
        return "tobecomplete/Incubator_base_tobe_complete_list";
    }
    ...
    public String queryIncubatorBaseByAab301(HttpServletRequest request, IncubatorBase incubatorBase, HttpServletResponse response) {
        try {
            ...
            incubatorBase.setIstobecomplete("1");//待审核设置该值为1
