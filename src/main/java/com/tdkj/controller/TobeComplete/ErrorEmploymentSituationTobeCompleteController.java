 ...
 */
@Controller
@RequestMapping("ErrorEmploymentSituationTobeComplete")
public class ErrorEmploymentSituationTobeCompleteController {
    ...
    @RequestMapping("list")
    public String list() {
        return "tobecomplete/error_employment_situation_tobe_complete_list";
    }
     ...
     * @return
     */
    @RequestMapping("queryErrorEmploymentSituationAccountByAab301")
    @ResponseBody
    public String queryErrorEmploymentSituationAccountByAab301(HttpServletRequest request, EysPlf eysPlf, HttpServletResponse response) {
        try {
            int pageSize = 50;
            int startRecord = 0;
            ...
            List<EysPlf> list = employmentSituationService.queryErrorEmploymentSituationAccountByAab301(eysPlf, startRecord + "", pageSize + "");
            String countlist = employmentSituationService.queryAllErrorEmploymentSituationByAab301(eysPlf);
