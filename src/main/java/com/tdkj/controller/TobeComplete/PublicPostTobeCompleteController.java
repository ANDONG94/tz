...
@Controller
@RequestMapping("PublicPostTobeComplete")
public class PublicPostTobeCompleteController {
    @Autowired
    ...
    @RequestMapping("list")
    public String list() {
        return "tobecomplete/public_post_tobe_complete_list";
    }
    ...
    public String queryPublicPostAccountByAab301(HttpServletRequest request, EysPlf eysPlf, HttpServletResponse response) {
        try {
            ...
            eysPlf.setIstobecomplete("1");//待完善信息  设置为1
