...
//异地搬迁统计
@RestController
@RequestMapping("EploymentStatistics")
public class EploymentStatisticsController {
    ...
    public String query(PoorHouseholdTranslation poorHouseholdTranslation){
        ...
        try {
            ...
            List<PoorHouseholdTranslation> list= statisticsService.EploymentQuery(poorHouseholdTranslation);
