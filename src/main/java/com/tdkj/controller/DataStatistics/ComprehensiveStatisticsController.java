...
//异地搬迁统计
@RestController
@RequestMapping("ComprehensiveStatistics")
public class ComprehensiveStatisticsController {
    ...
    public String query(PoorHouseholdTranslation poorHouseholdTranslation){
        ...
        try {
            ...
            List<PoorHouseholdTranslation> list= statisticsService.CooperationQuery(poorHouseholdTranslation);
    ...
    @RequestMapping("/getaab301")
    public String getaab301(){
                //从session中获取当前登录人的aab301 行政区划
        FpUser fpUser = (FpUser)request.getSession().getAttribute("fpUser");
        String aab301 = fpUser.getAab301();
        return aab301;
    }
}
