...
//异地搬迁统计
@RestController
@RequestMapping("CooperationStatistics")
public class CooperationStatisticsController {
    @Autowired
    ...
    public String query(PoorHouseholdTranslation poorHouseholdTranslation){
        ...
        try {
            ...
            List<PoorHouseholdTranslation> list= statisticsService.ComprehensiveQuery(poorHouseholdTranslation);
