        ...
        function setState( val ) {
            ...
            switch ( state ) {
                ...
                case 'finish':
                    stats = uploader.getStats();
                    if ( stats.successNum ) {
                        // 暂时注释  document.getElementById("shareUrl").style.visibility = 'visible';
                        // createQrcode();
                        //刷新datatables表格
                        closeUploader();
                        uploader.reset();
                        swal("成功成功！", "图片上传成功。", "success");
                        tdkj_datatable.ajax.reload();  // 成功之后刷新页面
